        ...
        <Modal closeModal={() => setShowModal(false)} size={"xl"} isOpen={showModal}>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <AppInput name="from" type={"text"} required label="Query To" />
              <AppInput name="against" type={"text"} required label="Query Title" />
              <AppInput name="company" type={"text"} required label="Company" />
              <AppInput name="Award_present" type="select" required label="Query Type"
                options={[
              ...
              <AppInput name="query_date" type={"date"} required label="Query Date" />
            </div>
          ...
          <div className="">
            <table className="w-full divide-y text-sm text-left">
              <tr className="bg-gray-100">
                ...
                <th className="hidden sm:table-cell">Query Date</th>
              ...
              <tr>
                ...
                <td className="hidden lg:table-cell">
                  <div className="">Harassment</div>
                </td>
                <td className="hidden lg:table-cell">
                  <div className="">16/05/2024 - 09:24</div>
                </td>
                <td className="hidden lg:table-cell">
                  <div className="">Unsolved</div>
                </td>
                <td>
