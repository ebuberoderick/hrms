              ...
              <tr>
                <td className="flex items-center gap-3 pl-5 py-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="">Expected Bugdget :800</div>
                    <div className="">Actual Budget : 750</div>
                    <div className="bg-hrms_green text-center rounded-lg text-white py-2 cursor-pointer ">Approved</div>
                  </div>
                </td>
