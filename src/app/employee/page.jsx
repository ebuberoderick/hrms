      ...
      <>
        <div className=" flex items-center justify-between">
          ...
          <div className="flex gap-[10px] text-sm">
            <div className="flex cursor-pointer font-bold gap-2 items-center border border-[#112255] text-[#112255] px-7 py-3 rounded-[4px]">
              <i className="ri-upload-2-fill text-[#112255]"></i>
        ...
        <div className="my-[32px] max-w-[461px] flex items-center gap-[20px]">
          <div className="w-[334px] relative py-[12px] pr-[30px] border border-[#112255] rounded-[10px]">
            <input
              type="text"
              placeholder="Search..."
              className="pl-2 w-full placeholder:text-[#112255] outline-none text capitalize"
            />
