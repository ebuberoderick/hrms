        ...
        <div className="lg:flex space-y-3 items-center justify-between">
          <div className="">
            ...
            <p className=" text-[12px] font-[400] text-[#00000099] text-opacity-60">
              All the payroll settings are listed here.
            </p>
          </div>
          ...
          <div className="">
            <table className="w-full divide-y text-xs text-left">
              <tr className="bg-gray-100">
                ...
                <th className="hidden sm:table-cell">Organization ID</th>
                <th className="">Number Of Pay Days</th>
              </tr>
              {/* {
                            ...
                            } */}
              {
                isloading && ["", "", "", "", ""].map((list, i) => (
                  <tr className="" key={i}>
                    ...
                    <th className=""><div className="preload py-2 w-2/3"></div></th>
                  </tr>
                ))
              }
            </table>
