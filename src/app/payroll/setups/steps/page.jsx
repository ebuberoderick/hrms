        ...
        <div className="">
          <form onSubmit={add} className="space-y-4">
            <div className="space-y-2">
              <div className="text-hrms_green text-xl">Add New Grade Step</div>
              <div className="grid grid-cols-2 gap-4">
                <AppInput name="employee_id" type={"select"} required label="Organization" options={[]} />
                <AppInput name="job_title_id" type={"select"} required label="Description" options={[]} />
                <AppInput name="grade_level_id" type={"select"} required label="Grade Step" options={[]} />
                <AppInput name="grade_step_id" type={"select"} required label="Active" options={[]} />
              </div>
            </div>
            <div>
              <button disabled={proccessingAdd} className="bg-hrms_green disabled:bg-opacity-40 w-full text-white rounded-lg py-2 text-center cursor-pointer">{proccessingAdd ? "Adding Grade Step" : "Add Grade Step"}</button>
            </div>
          </form>
        </div>
      </Modal>
        ...
        <div className="lg:flex space-y-3 items-center justify-between">
          <div className="">
            ...
            <p className=" text-[12px] font-[400] text-[#00000099] text-opacity-60">
              All the payroll steps are listed here.
            </p>
          </div>
