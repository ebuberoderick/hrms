...
export const updateProfile = (formData) => apiWithAuth.post('/user/profile/update-profile', formData).then(getApiResponse).catch(getErrorResponse).catch(err => console.log(err));
