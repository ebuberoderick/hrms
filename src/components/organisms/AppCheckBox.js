...
function AppCheckBox({ name, Boxlable, type, display }) {
  return (
    <div className="flex text-sm">
      <div
        className={`space-x-2 relative -left-2 flex select-none items-center justify-center ${
          display === "col" && "flex-col pb-6"
        }`}
      >
        <input
          type={type}
        ...
        <label
          ...
          className={`cursor-pointer flex gap-1 peer-checked:text-blue-400 ${
            display === "col"
